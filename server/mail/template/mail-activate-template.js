...
module.exports.getMailActivateTemplate=(recipient, verifyToken) => {
    let content = `
                                                                                            ...
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        ...
                                                                                                        <p><a style="color:#007db8;" href="https://www.tecknocracy.com/#/activate-account/${verifyToken.token}">https://www.tecknocracy.com/#/activate-account/${verifyToken.token}</a></p><br/>
