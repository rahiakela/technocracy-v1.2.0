...
module.exports.getQuestionSaveMailTemplate=(question, askedByUser) => {
    let content = `
                                                                                            ...
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        ...
                                                                                                        <p>This question is just asked by <strong>${askedByUser}</strong> on <strong>${moment(question.createdOn).format('LLLL')}</strong>.He is waiting for approval of this question, so please have a look and approve and mark it published.</p>
                                                                                                        <br/>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                        ...
                                                        <td valign="top" class="specbundle2"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                                            ...
                                                            <tr>
                                                                <td align='left' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <p>${question.content.length > 299 ? mailSender.decodeHTML(question.content.substring(0,300)) : mailSender.decodeHTML(question.content)}</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align='right' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable" >
                                                                            <a target='_blank' href="http://www.tecknocracy.com/#/question/${question._id}" class='link1'>Review →</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
