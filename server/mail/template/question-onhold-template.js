...
module.exports.getOnHoldQuestionMailTemplate = (question, recipient, askedBy) => {
    let content = `
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p>Hey <strong>${askedBy}</strong>,</p>
                                                                                                        <p>Thanks for using <strong>Technocracy</strong>. This question is just asked by you on ${moment(question.createdOn).format('LLLL')} and I want to inform you that your question has been put on hold for some further clarification, so please have patience, we will keep you updated about your question.</p>
                                                                                                        <br/>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td align='left' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <p >
                                                                                ${mailSender.decodeHTML(question.content)}                                                     
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                                    <tr>
                                                        <td valign='top' align='center'>
                                                            <div class="contentEditableContainer contentTextEditable">
                                                                <div class="contentEditable" >
                                                                    <p style='color:#A8B0B6; font-size:13px;line-height: 16px;'>This email was sent to <a href="mailto:${mailSender.getUserName(recipient)}" target=\\"_blank\\">${mailSender.getUserName(recipient)}</a> when you signed up on technocracy.com Please add us to your contacts to ensure the newsletters land in your inbox.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
