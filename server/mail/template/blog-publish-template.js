...
module.exports.getBlogPublishMailTemplate=(blog, recipient) => {
                                                                ...
                                                                <tr>
                                                                  <td align='left' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                      <div class="contentEditable" >
                                                                        <p >
                                                                            ${mailSender.decodeHTML(blog.content.substring(0,300))}
                                                                        </p>
                                                                      </div>
                                                                    </div>
                                                                  </td>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                          <td valign="top" width="110" class="specbundle">
                                                                              <div class="contentEditableContainer contentImageEditable">
                                                                                  <div class="contentEditable" >
                                                                                    <img src="${mailSender.getUserIcon(blog.profile.user) !== '' ? mailSender.getUserIcon(blog.profile.user) : process.env.CLOUD_IMAGE_PATH+'/images/user.png'}" alt='product image' data-default="placeholder" style="border-radius:50%;" width="100" height="90" class="banner">
                                                                                  </div>
                                                                              </div>
                                                                          </td>
                                                                          <td>
                                                                                      ...
                                                                                      <td>
                                                                                          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >                                                                                                   
                                                                                              <tr>
                                                                                                <td>
                                                                                                  <div>
                                                                                                      <p style="color: #007db8;">${blog.profile.name},${blog.profile.city},${blog.profile.country}</p>
                                                                                                      <p>
                                                                                              ...
                                                                                              <tr>
                                                                                                  <td align='right' valign='top'>
                                                                                                      <div class="contentEditableContainer contentTextEditable">
                                                                                                          <div class="contentEditable" >
                                                                                                              <a target='_blank' href="http://www.tecknocracy.com/#/profile/${blog.profile._id}" class='link1'>View profile →</a>
                                                                                                          </div>
                                                                                                      </div>
                                                                                                  </td>
                                                                                              </tr>
