...
const dateUtil = require("../../utils/data-time-util");

module.exports.getCommentMailTemplate=(mailOptions, recipient, notifyType) => {
    let _id = notifyType === 'blog'? mailOptions.get("blog")[0]._id : mailOptions.get("question")[0]._id;
    let title = notifyType === 'blog'? mailOptions.get("blog")[0].title : mailOptions.get("question")[0].title;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td  align='left' style="width: 130px; padding-top: 45px;" >
                                                                            <div class="contentEditableContainer contentImageEditable" style='display:inline-block;'>
                                                                                <div class="contentEditable" >
                                                                                    <p style="color: white;">${dateUtil.getDateString()}</p>                                                                                    
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p><strong>${mailSender.getUserName(mailOptions.get("user"))}</strong> commented on <strong><a href="https://www.tecknocracy.com/#/${notifyType}/${_id}" style="color:#007db8;">${title}</a></strong> ${notifyType}:</p><br/>
                                                                                                        `;
    if (mailOptions.get("reply")){
        content += `
                                                                                                        <p>in response to <strong>${mailSender.getUserName(mailOptions.get("comment")[0].commentedBy)}</strong>:</p>
                                                                                                        <blockquote style="font-family: Times, serif;font-size: 1.1em;font-style: italic;color: #878787;border-left: 3px solid #ccc;margin: 1em 1em 1em 2em;padding-left: 1em;">
                                                                                                            <p style="color: #007db8;font-weight: bold;">${mailSender.decodeHTML(mailOptions.get("comment")[0].content)}</p>
                                                                                                        </blockquote>
        `;
    }
    if (mailOptions.get("reply")){
        content += `
                                                                                                        <p style="color: #007db8;font-weight: bold;">${mailSender.decodeHTML(mailOptions.get("reply").content)}</p>
        `;
    } else {
        content += `
                                                                                                        <p style="color: #007db8;font-weight: bold;">${mailSender.decodeHTML(mailOptions.get("comment").content)}</p>
        `;
    }
    content +=`                                                                                                                                                                                                              
                                                                                                        <br/>
