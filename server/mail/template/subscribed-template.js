module.exports.getSubscribedTemplate = (recipient) => {
    let content = `
                                                        ...
                                                        <td align="center" class="m_2760232353335187221mktEditable" id="m_2760232353335187221headline_image" style="font-size:1px;line-height:1px">
                                                            <div>
                                                                <a href="https://www.tecknocracy.com/">
                                                                    <img data-max-width="560" height='200' width='560' border="0" alt="" style="display:block;border:none;outline:none;text-decoration:none;width:100%!important;" src="${process.env.CLOUD_IMAGE_PATH}/images/tech-blog-logo.jpg" class="CToWUd a6T" tabindex="0">
