...
module.exports.getQuestionPublishMailTemplate=(question, recipient, askedByUser) => {
    let content = `
    ...
    if(recipient._id.toString() === question.askedBy._id.toString()) {
        content += `
                                                                                                        <br/>
                                                                                                        <p>Hey <strong>${mailSender.getUserName(recipient)}</strong>,</p>
                                                            ...
                                                            <tr>
                                                                <td align='left' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <p>
                                                                                ${question.content.length > 299 ? mailSender.decodeHTML(question.content.substring(0,300)) : mailSender.decodeHTML(question.content)}                                                                              
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
